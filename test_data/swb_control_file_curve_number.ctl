...
# Output options
#---------------
OUTPUT ENABLE runoff runoff_outside gross_precip snowmelt rainfall
OUTPUT ENABLE tmax tmin snow_storage reference_ET0 actual_et
...
# Dump all variables for a single grid cell for comparison
